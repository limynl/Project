...
import com.limynl.project.utils.DateUtil;
...
public class SocialMessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public SocialMessageAdapter(List<Feed> list) {
